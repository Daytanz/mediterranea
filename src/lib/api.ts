...
// Backend URL hardcoded for Render deployment stability
// This avoids environment variable issues on static hosting
const API_URL = 'https://mediterranea.onrender.com/api';
