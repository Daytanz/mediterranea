                    ...
                    {editingId === cat.id ? (
                      <div className="space-y-2">
                        <div className="w-24 h-16 rounded-lg bg-zinc-100 overflow-hidden relative border border-zinc-200">
                          {previewUrl ? (
                            <img 
                              src={previewUrl.startsWith('http') || previewUrl.startsWith('blob') ? previewUrl : `http://localhost:5001${previewUrl}`} 
                              alt="Preview" 
                      ...
                      <div className="w-24 h-16 rounded-lg bg-zinc-100 overflow-hidden relative border border-zinc-200">
                        {cat.foto_url ? (
                          <img 
                            src={cat.foto_url.startsWith('http') ? cat.foto_url : `http://localhost:5001${cat.foto_url}`} 
                            alt={cat.nome}
                            className="w-full h-full object-cover"
                          />
                        ) : (
